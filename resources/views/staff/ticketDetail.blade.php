            ...
            <div class="col d-flex flex-column gap-4">
                ...
                <div class="card card-body">
                    ...
                    @elseif($ticket->status === 1)
                        ...
                        <span class="badge text-bg-primary fs-5 mb-2 progress-bar progress-bar-striped progress-bar-animated">In
                            Progress</span>
            ...
            <div class="col">
                ...
                <div class="card p-5 text-center">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('staff.dashboard') }}?service_id={{ $ticket->service->id }}" class="btn btn-outline-secondary py-4"><i
                                class="bi bi-arrow-return-left me-2"></i> Back to Dashboard</a>
                        @if($ticket->status === 0)
                        ...
                        @elseif($ticket->status === 1)
                            ...
                            <a href="{{ route('ticket.close', ['id' => $ticket->id]) }}"
                               class="btn btn-outline-success py-4"
                               @if(!$canResolve)
